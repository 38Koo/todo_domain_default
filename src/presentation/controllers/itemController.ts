...
import { getItemListRoute } from "../schemas/ItemSchema.js";

const ItemController = new OpenAPIHono();

ItemController.doc("/doc", {
  openapi: "3.0.0",
  info: {
    version: "1.0.0",
    title: "todo api",
...
ItemController.openapi(getItemListRoute, async (c) => {
